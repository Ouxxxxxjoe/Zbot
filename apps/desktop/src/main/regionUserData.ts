 ...
 * 区域派生),但 Electron 默认 userData 目录由 package.json productName(zagent)
 ...
 * 历史兼容：cn=`Zbot`、global=`ZbotGlobal`；内部 dev 身份使用 `zagentDev`。
 *
 * 语义边界:
 ...
 *    profile，确保隔离 epoch comparison 以 ZbotGlobal / Zbot / zagentDev 为基线。
