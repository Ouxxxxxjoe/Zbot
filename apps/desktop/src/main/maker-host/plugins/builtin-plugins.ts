...
const BUILTIN_META: BuiltinPluginMeta[] = [
  ...
  { id: 'ios-simulator', name: 'iOS Simulator', description: 'Zbot embedded iOS Simulator — create or attach a session-owned device, boot it in the embedded viewer, build/install/launch apps, inspect screens, and debug interactions.' },
  ...
  { id: 'xdt_helper',   name: 'Zbot Helper', description: 'Host capability disclosure — tells agents what tools and models are available' },
